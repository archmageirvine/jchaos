...
public class VirtueTest extends AbstractFreeCastableTest {
  ...
  public void test1() {
    ...
    world.getCell(0).push(new WhiteDragon());
    world.getCell(1).push(new Skeleton());
    final Horse h = new Horse();
    world.getCell(2).push(h);
    final Horse dh2 = new Horse();
    dh2.setState(State.DEAD);
    world.getCell(3).push(dh2);
    final WhiteDragon mw = new WhiteDragon();
    mw.setOwner(3);
