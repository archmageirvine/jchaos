 ...
 */
public class MagicSwordTest extends AbstractCastableTest {
  ...
  public void testCast() {
    ...
    assertEquals(1, l.get(PowerUps.SWORD));
    assertEquals(1, l.get(PowerUps.ATTACK_ANY_REALM));
    assertEquals(l.getDefault(Attribute.COMBAT) + 5, l.get(Attribute.COMBAT));
  ...
  public void testFilter2() {
    ...
    final Wizard1 wiz = new Wizard1();
    wiz.setOwner(1);
    final MagicSword x = new MagicSword();
    final HashSet<Cell> t = new HashSet<>();
