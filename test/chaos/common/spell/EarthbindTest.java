 ...
 */
public class EarthbindTest extends AbstractCastableTest {

  @Override
  public Castable getCastable() {
    return new Earthbind();
  }
  ...
  public void testCast() {
    final Earthbind x = new Earthbind();
    ...
    assertFalse(w.is(PowerUps.FLYING));
