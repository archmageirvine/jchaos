 ...
 */
public class ExorciseTest extends AbstractDrainerTest {
  ...
  public void testParams() {
    final Exorcise cons = new Exorcise();
    assertEquals(Castable.CAST_LIVING | Castable.CAST_NOEXPOSEDWIZARD | Castable.CAST_MUSTBEUNDEAD, cons.getCastFlags());
    assertEquals(Castable.MAX_CAST_RANGE, cons.getCastRange());
    assertEquals(85, cons.getDamage());
