 ...
 */
public class HyadicTest extends AbstractCastableTest {
  ...
  public void testCast() {
    final Hyadic x = new Hyadic();
    assertEquals(Castable.CAST_LIVING | Castable.CAST_INANIMATE | Castable.CAST_GROWTH | Castable.CAST_DEAD, x.getCastFlags());
    assertEquals(100, x.getCastRange());
    assertEquals(5, x.getMultiplicity());
    ...
    assertEquals(Realm.HYADIC, w.getRealm());
