 ...
 */
public class DragonAscentTest extends AbstractCastableTest {
  ...
  public void testCast() {
    final DragonAscent x = new DragonAscent();
    ...
    assertEquals(Realm.DRACONIC, w.getRealm());
