...
public final class TileManagerFactory {
  ...
  /** 64 by 64 animated tiles. */
  public static final String ACTIVE64 = "chaos.graphics.active64.Active64TileManager";
  ...
  public static TileManager getTileManager(final String name) {
    ...
    if (ACTIVE64.equals(name)) {
      return new chaos.graphics.active64.Active64TileManager();
    } else if (ACTIVE32.equals(name)) {
