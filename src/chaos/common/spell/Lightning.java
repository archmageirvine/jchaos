 ...
 */
public class Lightning extends Castable implements TargetFilter {
  ...
  public void cast(final World world, final Caster caster, final Cell cell, final Cell casterCell) {
    if (cell != null) {
      if (casterCell != null) {
        cell.notify(new WeaponEffectEvent(casterCell, cell, WeaponEffectType.LIGHTNING));
      }
      ...
      if (a != null) {
        if (a.getState() == State.DEAD) {
          ...
          final int mr = a.get(Attribute.MAGICAL_RESISTANCE) - LIGHTNING_DAMAGE;
          if (mr > 0) {
            // survived
